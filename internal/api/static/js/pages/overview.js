// FangClaw-go Overview Dashboard — Landing page with system stats + provider status
'use strict';
  ...
  return {
    ...
    async loadMcpServers() {
      try {
        ...
        // Backend returns data.connected array with connected servers
        this.mcpServers = (data.connected || []).map(function(server) {
          return {
            name: server.name,
            status: 'connected',
